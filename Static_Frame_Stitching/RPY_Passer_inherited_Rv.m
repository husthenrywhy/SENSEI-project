...
function RPY_Passer_inherited_Rv(Date_str,frame_Num_idx,frame_RPY_idx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
RPY_pto_filename=strcat(Date_str,'_StarCam_',num2str(frame_RPY_idx,'%06i'),'_VR_inherited.pto');
