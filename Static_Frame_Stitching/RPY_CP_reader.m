...
function [updated_pto_filename]=RPY_CP_reader(Num_pto_filename,RPY_pto_filename,frame_RPY_idx,frame_Num_idx)
%clear;clc;
%old_frame_num=1;
%new_frame_num=2;
%Num_pto_filename = '20180130_StarCam_000001_VL_modified2.pto';
%RPY_pto_filename = '20180130_StarCam_000002_VL_sift_tracked.pto';

updated_pto_filename = strrep(Num_pto_filename, 'VL.pto', 'VL_inherited.pto');
