...
function RPY_Passer_ind_Lv(Date_str,frame_Num_idx,frame_RPY_idx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
RPY_pto_filename=strcat(Date_str,'_StarCam_',num2str(frame_RPY_idx,'%06i'),'_VL_modified_2.pto');
