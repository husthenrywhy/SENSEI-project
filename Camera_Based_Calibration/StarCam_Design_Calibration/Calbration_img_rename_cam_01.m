...
selected_idx_list_p1=63:86;
selected_idx_list_p2=330:335;
selected_idx_list_p3=393:403;
selected_idx_list_p4=696:891;
...
for img_index= selected_idx_list(1:100)
    ...
    %% Output path
    Output_path_L=strcat('./cam_01/L_syn/','Cal_01_L_',num2str(selected_count,'%03i'),'.jpg');
    Output_path_R=strcat('./cam_01/R_syn/','Cal_01_R_',num2str(selected_count,'%03i'),'.jpg');
