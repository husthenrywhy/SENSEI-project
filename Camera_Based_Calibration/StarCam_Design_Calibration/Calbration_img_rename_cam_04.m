...
selected_idx_list_p1=3+2:10+2;
selected_idx_list_p2=109+3:127+3;
selected_idx_list_p3=198+3:208+3;
selected_idx_list_p4=350+3:355+3;
selected_idx_list_p5=422+3:469+3;
selected_idx_list_p6=1001+3:1139+3;
...
for img_index= selected_idx_list(1:100)
    ...
    %% Output path
    Output_path_L=strcat('./cam_04/L_syn/','Cal_04_L_',num2str(selected_count,'%03i'),'.jpg');
    Output_path_R=strcat('./cam_04/R_syn/','Cal_04_R_',num2str(selected_count,'%03i'),'.jpg');
