...
selected_idx_list_p1=179:184;
selected_idx_list_p2=261:271;
selected_idx_list_p3=405:412;
selected_idx_list_p4=796:1000;
...
for img_index= selected_idx_list(1:100)
    ...
    %% Output path
    Output_path_L=strcat('./cam_02/L_syn/','Cal_02_L_',num2str(selected_count,'%03i'),'.jpg');
    Output_path_R=strcat('./cam_02/R_syn/','Cal_02_R_',num2str(selected_count,'%03i'),'.jpg');
