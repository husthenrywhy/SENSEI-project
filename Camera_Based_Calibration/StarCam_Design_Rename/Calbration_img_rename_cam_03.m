...
% selected_idx_list_p1=200:207;
% selected_idx_list_p2=308:317;
% selected_idx_list_p3=412:455;
% selected_idx_list_p4=877:1112;
...
% selected_idx_list=[selected_idx_list_p1 selected_idx_list_p2 selected_idx_list_p3 selected_idx_list_p4];
...
for img_index= frame_start:frame_end
    ...
    %% Output path
    Output_path_L=strcat('./cam_03/L_syn/','20181029_StarCam_03_L_',num2str(selected_count,'%03i'),'.jpg');
    Output_path_R=strcat('./cam_03/R_syn/','20181029_StarCam_03_R_',num2str(selected_count,'%03i'),'.jpg');
