...
% selected_idx_list_p1=24:43;
% selected_idx_list_p2=282:296;
% selected_idx_list_p3=472:489;
% selected_idx_list_p4=681:698;
% selected_idx_list_p5=760:876;
...
for img_index= frame_start:frame_end
    ...
    %% Output path
    Output_path_L=strcat('./cam_05/L_syn/','20181029_StarCam_05_L_',num2str(selected_count,'%03i'),'.jpg');
    Output_path_R=strcat('./cam_05/R_syn/','20181029_StarCam_05_R_',num2str(selected_count,'%03i'),'.jpg');
