...
% selected_idx_list_p1=1:27;
% selected_idx_list_p2=145:166;
% selected_idx_list_p3=265:282;
% selected_idx_list_p4=488:508;
% selected_idx_list_p5=666:681;
...
for img_index= frame_start:frame_end
    ...
    %% Output path
    Output_path_L=strcat('./cam_06/L_syn/','20181029_StarCam_06_L_',num2str(selected_count,'%03i'),'.jpg');
    Output_path_R=strcat('./cam_06/R_syn/','20181029_StarCam_06_R_',num2str(selected_count,'%03i'),'.jpg');
