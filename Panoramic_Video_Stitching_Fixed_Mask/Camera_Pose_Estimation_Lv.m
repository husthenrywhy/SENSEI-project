...
function Camera_Pose_Estimation_Lv(Date_str,frame_input,opt_mode)
frame_idx=frame_input;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%% Pre-Set Parameters View %%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Input_pto_filename0=strcat(Date_str,'_StarCam_',num2str(frame_idx,'%06i'),'_VL_sift_tracked.pto');
    Output_pto_filename0=strcat(Date_str,'_StarCam_',num2str(frame_idx,'%06i'),'_VL_preset_v.pto');
...
% Position
    ...
    Output_pto_filename1=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_position.pto');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Output_pto_filename2=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_position_optimized.pto');
...
if opt_mode ==2 % Position View Barrel
    ...
    Output_pto_filename3=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_PVB.pto');
...
elseif opt_mode==3    
    Input_pto_filename3=Output_pto_filename2;
    Output_pto_filename3=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_E.pto');
...
Output_pto_filename4=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_position_optimized2.pto');
...
% 
% Input_pto_filename3=Output_pto_filename2;
% Output_pto_filename3=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_rpyvb_var.pto');
% 
...
% 
% Input_pto_filename4=Output_pto_filename3;
% Output_pto_filename4=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_rpyvb_optimized.pto');
% 
% Opt_cmd_4=strcat('autooptimiser -n -o', {' '}, Output_pto_filename4,{' '},Input_pto_filename4);
%[status4,cmdout4] = system(Opt_cmd_4{1});
%% Output Panorama
...
Output_pto_filename5=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_modified.pto');
...
Output_pto_filename6=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_modified_2.pto');
...
% Output_pto_filename7=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_final.pto');
% Output_panorama_filename=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_tracked.jpg');
% 
