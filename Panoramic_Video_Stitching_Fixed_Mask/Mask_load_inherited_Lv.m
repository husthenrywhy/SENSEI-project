...
%target_idx=16;
%for frame_idx=17
function Mask_load_inherited_Lv(frame_input,frame_mask_input)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for cam_idx=1
    ...
    % Mask_name{cam_idx}=strcat('--load-masks=mask_VL_',num2str(frame_idx,'%06i'),L_cam_idx_str,R_cam_idx_str,'.tif');
    Mask_name{cam_idx}=strcat('--load-masks=mask_VL_',num2str(frame_target_idx,'%06i'),L_cam_idx_str,R_cam_idx_str,'.tif');
