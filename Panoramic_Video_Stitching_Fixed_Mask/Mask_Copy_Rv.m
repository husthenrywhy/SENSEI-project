function Mask_Copy_Rv(frame_input,frame_mask_input)
    camera_num=8;
    ...
    for cam_idx=1:camera_num-1
        ...
        Mask_name_original{cam_idx}=strcat('mask_VR_',num2str(frame_mask_idx,'%06i'),L_cam_idx_str,R_cam_idx_str,'.tif');
        Mask_name_new{cam_idx}=strcat('mask_VR_',num2str(frame_idx,'%06i'),L_cam_idx_str,R_cam_idx_str,'.tif');
