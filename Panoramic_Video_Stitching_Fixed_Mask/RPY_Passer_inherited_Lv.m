...
% target_frame_idx=18;
% target_pto_filename=strcat('20181029_StarCam_',num2str(target_frame_idx,'%06i'),'_VL_updated_renew_p2.pto');
...
function RPY_Passer_inherited_Lv(Date_str,frame_Num_idx,frame_RPY_idx)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Construct original pto files with frame_Num_idx %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
New_pto_filename=strcat(Date_str,'_StarCam_',num2str(frame_Num_idx,'%06i'),'_VL.pto');
...
image_filename=strcat(image_filename_p1,'_VL*.png');
...
Num_pto_filename=strcat(Date_str,'_StarCam_',num2str(frame_Num_idx,'%06i'),'_VL.pto');
RPY_pto_filename=strcat(Date_str,'_StarCam_',num2str(frame_RPY_idx,'%06i'),'_VL_inherited.pto');

[updated_pto_filename]=RPY_CP_reader(Num_pto_filename,RPY_pto_filename,frame_RPY_idx,frame_Num_idx);
