...
for frame_idx=2:250
%frame_idx=1;
Input_pto_filename0=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_sift_tracked.pto');
Output_pto_filename0=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_preset_v.pto');

Opt_cmd_0=strcat('pto_var --output=',Output_pto_filename0,{' '} ,'--set=v=60',{' '},Input_pto_filename0);
[status0,cmdout0] = system(Opt_cmd_0{1});    
    
%frame_idx=1;
% Input_pto_filename1=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_sift_tracked.pto');
Input_pto_filename1=Output_pto_filename0;
Output_pto_filename1=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_position_var.pto');
...
Output_pto_filename6=strcat('20181029_StarCam_',num2str(frame_idx,'%06i'),'_VL_modified2.pto');

Opt_cmd_6=strcat('pano_modify -c --fov=360x180 --canvas=12000x6000 --crop=0,12000,0,6000 --ldr-file=JPG --blender=INTERNAL --output=',Output_pto_filename6, {' '}, Input_pto_filename6);
